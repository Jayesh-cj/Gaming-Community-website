<?php
  ...
  $selCom="select * from tbl_joinlist l inner join tbl_community c on l.community_id=c.community_id where c.user_id='".$_SESSION['uid']."' or l.list_status=1 GROUP by l.community_id";
      ...
      ?>
        <tr>
          ...
          <th scope="row" style="width: 150px; text-align: center;">
            <a href="CommunityHomepage.php?c_id=<?php echo $data['community_id']; ?>" class="text-white"> <!-- Set link text color to white -->
